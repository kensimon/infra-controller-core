...
use ::rpc::forge::{
    BmcEndpointRequest, CreateNetworkSecurityGroupRequest, FindInstanceTypesByIdsRequest,
    ...
    VpcCreationRequest, VpcSearchFilter, VpcVirtualizationType, VpcsByIdsRequest, {self as rpc},
};
